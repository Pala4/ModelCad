...
void __fastcall CGrps::ShowHintCoord(int MX, int MY)
{
   ...
   if(!HW)
   {
   	...
   	Windows::TRect rect(ClientToScreen(Point(MX, MY - TS.cy - 4)),
                 ...
                 :TWinControl(AOwner)
{
   ...
   TMenuItem **Items = new TMenuItem*[1];
   Items[0] = NewItem("Свойства", TextToShortCut(""),
                      false, true,
                      OnMIPropertyClick,
                      0, "MIProperty");
   PopupMenu = NewPopupMenu(this, "PMGrp", paLeft, true,
                            Items, 0);
   delete []Items;
